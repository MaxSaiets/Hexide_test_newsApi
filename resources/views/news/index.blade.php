<x-app>
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="flex items-center justify-between mb-8">
            <h2 class="text-2xl font-bold tracking-tight text-gray-900">Останні новини</h2>
        ...
        @if($news->isEmpty())
            <p class="text-center text-gray-500 py-12">Новин не знайдено</p>
        @else
